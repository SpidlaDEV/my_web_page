...
<html class="no-js">
    <head>
        ...
        <title>Alex Spidla &mdash; Clientes</title>
                        ...
                        <div class="nav-header">
                            ...
                            <nav id="fh5co-menu-wrap" role="navigation">
                                <ul class="sf-menu" id="fh5co-primary-menu">
                                    ...
                                    <li class="active"><a href="client.jsp">Cliente</a></li>
                                    <li><a href="../worker.jsp">Empleado</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <input type="date" class="form-control" placeholder="Fecha de Nacimiento" name="birthday">
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" placeholder="Nacionalidad" name="nationality">
                                        </div>
                                    </div>
                                </div>
